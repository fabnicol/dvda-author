...
pkgdatadir = $(datadir)/dvda-author
pkgincludedir = $(includedir)/dvda-author
pkglibdir = $(libdir)/dvda-author
pkglibexecdir = $(libexecdir)/dvda-author
...
DIST_COMMON = README $(am__configure_deps) $(am__dist_doc_DATA_DIST) \
	...
	$(dist_sysconf_DATA) $(srcdir)/EXAMPLES.in \
	$(srcdir)/Makefile.am $(srcdir)/Makefile.in \
	$(srcdir)/config.h.in $(srcdir)/dvda-author-shared.spec.in \
	$(srcdir)/dvda-author.desktop.in $(srcdir)/dvda-author.nsi.in \
	$(srcdir)/dvda-author.spec.in $(srcdir)/script.in \
	$(srcdir)/script1.in $(srcdir)/script2.in $(srcdir)/script3.in \
	$(top_srcdir)/configure AUTHORS COPYING ChangeLog INSTALL NEWS \
	TODO config/compile config/config.guess config/config.sub \
	config/depcomp config/install-sh config/missing
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
am__aclocal_m4_deps = $(top_srcdir)/m4/acinclude.m4 \
	$(top_srcdir)/m4/dependencies.m4 $(top_srcdir)/m4/dvda.m4 \
	$(top_srcdir)/m4/auxiliary.m4 $(top_srcdir)/m4/oggflac-test.m4 \
...
CONFIG_CLEAN_FILES = dvda-author.desktop dvda-author-shared.spec \
	dvda-author.spec dvda-author.nsi script script1 script2 \
	script3 EXAMPLES
...
am__installdirs = "$(DESTDIR)$(man1dir)" "$(DESTDIR)$(docdir)" \
	"$(DESTDIR)$(menudir)" "$(DESTDIR)$(pixdir)" \
	"$(DESTDIR)$(sysconfdir)"
NROFF = nroff
MANS = $(dist_man_MANS)
am__dist_doc_DATA_DIST = README BUGS EXAMPLES LIMITATIONS HOWTO.conf \
	dvda-author.conf.example dvda-author.html
DATA = $(dist_doc_DATA) $(dist_menu_DATA) $(dist_pix_DATA) \
	$(dist_sysconf_DATA)
...
ACLOCAL = ${SHELL} /home/dvda-author/master/dvda-author-10.06.win32/config/missing --run aclocal-1.11
ALL_VERSION = 
AMTAR = ${SHELL} /home/dvda-author/master/dvda-author-10.06.win32/config/missing --run tar
AUTOCONF = /usr/bin/autoconf
AUTOHEADER = ${SHELL} /home/dvda-author/master/dvda-author-10.06.win32/config/missing --run autoheader
...
JPEG2YUV = 
LDFLAGS =  -L/usr/lib -L/usr/local/lib -lm -L/usr/local/lib/fixwav -L/usr/local/lib/FIXWAV
LIBOBJS =  ${LIBOBJDIR}error$U.o
LIBS =  -s
LIBSOXCONVERT_CPPFLAGS = 
LN_S = ln -s
LPLEX = 
LPLEX_CONFIGURE_FILE = 
LPLEX_LIB = 
LPLEX_LINK = 
LPLEX_VERSION = 
LTLIBOBJS =  ${LIBOBJDIR}error$U.lo
MAGICK_CONFIGURE_FILE = 
MAGICK_LIB = 
MAGICK_LINK = 
MAGICK_VERSION = 
MAKE = /usr/bin/make
MAKEINFO = ${SHELL} /home/dvda-author/master/dvda-author-10.06.win32/config/missing --run makeinfo
...
RANLIB = ranlib
ROOTDIR = /home/dvda-author/master/dvda-author-10.06.win32
SED = /usr/bin/sed
SET_MAKE = 
SHELL = /bin/sh
...
TAR = 
VERSION = 10.06
abs_builddir = /home/dvda-author/master/dvda-author-10.06.win32
abs_srcdir = /home/dvda-author/master/dvda-author-10.06.win32
abs_top_builddir = /home/dvda-author/master/dvda-author-10.06.win32
abs_top_srcdir = /home/dvda-author/master/dvda-author-10.06.win32
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/dvda-author/master/dvda-author-10.06.win32/config/install-sh
libdir = /usr/lib
...
SUBDIRS = ${MAYBE_IBERTY} libutils ${MAYBE_OGG} ${MAYBE_FLAC} ${MAYBE_FIXWAV} libats2wav ${MAYBE_SOX}  ${MAYBE_LPLEX} ${MAYBE_DVDAUTHOR} ${MAYBE_HELP2MAN} ${MAYBE_MJPEGTOOLS} ${MAYBE_MAGICK} src
DIST_SUBDIRS = libiberty libutils libfixwav src CB_project libats2wav images
...
dvda-author.desktop: $(top_builddir)/config.status $(srcdir)/dvda-author.desktop.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
dvda-author-shared.spec: $(top_builddir)/config.status $(srcdir)/dvda-author-shared.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
dvda-author.spec: $(top_builddir)/config.status $(srcdir)/dvda-author.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
dvda-author.nsi: $(top_builddir)/config.status $(srcdir)/dvda-author.nsi.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
script: $(top_builddir)/config.status $(srcdir)/script.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
script1: $(top_builddir)/config.status $(srcdir)/script1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
script2: $(top_builddir)/config.status $(srcdir)/script2.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
script3: $(top_builddir)/config.status $(srcdir)/script3.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
EXAMPLES: $(top_builddir)/config.status $(srcdir)/EXAMPLES.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
install-dist_menuDATA: $(dist_menu_DATA)
	...
	@list='$(dist_menu_DATA)'; test -n "$(menudir)" || list=; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	done | $(am__base_list) | \
...
install-dist_pixDATA: $(dist_pix_DATA)
	@$(NORMAL_INSTALL)
	test -z "$(pixdir)" || $(MKDIR_P) "$(DESTDIR)$(pixdir)"
	@list='$(dist_pix_DATA)'; test -n "$(pixdir)" || list=; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	done | $(am__base_list) | \
...
uninstall-dist_pixDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(dist_pix_DATA)'; test -n "$(pixdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	test -n "$$files" || exit 0; \
	echo " ( cd '$(DESTDIR)$(pixdir)' && rm -f" $$files ")"; \
	cd "$(DESTDIR)$(pixdir)" && rm -f $$files
...
installdirs-am:
	for dir in "$(DESTDIR)$(man1dir)" "$(DESTDIR)$(docdir)" "$(DESTDIR)$(menudir)" "$(DESTDIR)$(pixdir)" "$(DESTDIR)$(sysconfdir)"; do \
...
install-data-am: install-data-local install-dist_docDATA \
	install-dist_menuDATA install-dist_pixDATA install-man
...
uninstall-am: uninstall-dist_docDATA uninstall-dist_menuDATA \
	uninstall-dist_pixDATA uninstall-dist_sysconfDATA \
	uninstall-man
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-dist_docDATA install-dist_menuDATA \
	install-dist_pixDATA install-dist_sysconfDATA install-dvi \
	...
	uninstall-dist_docDATA uninstall-dist_menuDATA \
	uninstall-dist_pixDATA uninstall-dist_sysconfDATA \
	uninstall-man uninstall-man1
...
all: stamprecord0 stamprecord1 stamprecord2 stamprecord3 stamprecord4 stamprecord5 stamprecord6 stamprecord7 stamprecord8 do_sox_lib_deps_subst
...
#	cd ${MAYBE_OGG} &&  ${SHELL} configure ${CONFIGURE_OGG_FLAGS} && $(MAKETOOL) -j4 -k && $(MAKETOOL) install ; cd -
...
#cdrtools must be compiled with special make install parameters hence should not be included in the SUBDIRS list. Building/cleaning will need prior configuration.
stamprecord4: Makefile
	if test -f stamprecord4; then rm -f stamprecord4; fi; touch stamprecord4
	cd ${MAYBE_CDRTOOLS} && $(MAKETOOL) ; cd -

stamprecord5: Makefile
	if test -f stamprecord5; then rm -f stamprecord5; fi; touch stamprecord5
#	cd ${MAYBE_MJPEGTOOLS} && ${SHELL} configure --prefix=${prefix} ; cd -

stamprecord6: Makefile
	if test -f stamprecord6; then rm -f stamprecord6; fi; touch stamprecord6
#	cd ${MAYBE_HELP2MAN} && ${SHELL} configure --prefix=${prefix} ; cd -

stamprecord7: Makefile
	if test -f stamprecord7; then rm -f stamprecord7; fi; touch stamprecord7
#Here again a script is oddly requested.
#	chmod +x script2 && ${SHELL} script2

stamprecord8: Makefile
	if test -f stamprecord8; then rm -f stamprecord8; fi; touch stamprecord8
#	chmod +x script3 && ${SHELL} script3

dvda-author.1:
	${HELP2MAN} -s 1 -N -o ${PWD}/dvda-author.1 ${PWD}/src/dvda
...
#PATCH  09.12  We need to display in UTF-8 mode and take off an illicit file header created by man2html
	${MAN2HTML} < ${PWD}/dvda-author.1 | $(SED) -e s/Content-type\.\*\$\/'<meta http-equiv="content-type" content="text\/html; charset=UTF-8">'/ > ${PWD}/dvda-author.html
...
#	 cd ${MAYBE_MAGICK}; $(MAKETOOL) install; cd - ;
#	 cd ${MAYBE_LPLEX}; $(MAKETOOL)  install; cd - ;
...
#	if test -d libogg-${OGG_VERSION}; then mv libogg-${OGG_VERSION}/ libogg/; fi
