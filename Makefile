...
DIST_COMMON = README $(am__configure_deps) $(am__dist_doc_DATA_DIST) \
	...
	$(srcdir)/script1.in $(top_srcdir)/configure AUTHORS COPYING \
...
am__aclocal_m4_deps = $(top_srcdir)/m4/acinclude.m4 \
	...
	$(top_srcdir)/m4/sox-debug.m4 $(top_srcdir)/configure.ac
...
CONFIG_CLEAN_FILES = dvda-author.desktop dvda-author-shared.spec \
	dvda-author.spec dvda-author.nsi script script1 EXAMPLES
...
CDRTOOLS_LINK = 
CDRTOOLS_VERSION = 
CFLAGS = -Wall -Wextra -Wall -Wextra -std=c99  -DCPU_IS_LITTLE_ENDIAN
...
dist_menu_DATA = menu/black_PAL_720x576.jpg menu/black_PAL_720x576.png menu/silence.wav menu/activeheader
...
#	cd ${MAYBE_LIBOGG} &&  ${SHELL} configure ${CONFIGURE_LIBOGG_FLAGS} && $(MAKE) -j4 && $(MAKE) install ; cd -
