...
#define	ALIGN_LDOUBLE	4	/* alignment value for (long double *)	*/
#define	ALIGN_LDMASK	3	/* alignment mask  for (long double *)	*/
#define	SIZE_LDOUBLE	12	/* sizeof (long double)			*/
...
#define	ALIGN_TMAX	4	/* alignment value for (max type *)	*/
#define	ALIGN_TMMASK	3	/* alignment mask  for (max type *)	*/
#define	SIZE_TMAX	12	/* sizeof (max type)			*/
