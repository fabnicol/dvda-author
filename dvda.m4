...
#						SOX_BUILD						    yes/no				BUILD (>) DVDA_TEST_LIB, DVDA_ARG_WITH,DVDA_CONFIG_EXECUTABLE_LOCAL_INSTALL, DVDA_ARG_ENABLE > DVDA_ARG_ENABLE_DOWNLOAD
...
# Invoke DVDA_CONFIG_EXECUTABLE_LOCAL_INSTALL before
...
AC_DEFUN([DVDA_CONFIG_EXECUTABLE_LOCAL_INSTALL],               [DVDA_CONFIG([$1],[#executable_install])])
