...
//  QListWidgetItem *hdtvButton = new QListWidgetItem(normWidget);
//  hdtvButton->setIcon(QIcon(":/images/64x64/hdtv.png"));
//  hdtvButton->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);

//  QListWidgetItem *hdreadyButton = new QListWidgetItem(normWidget);
//  hdreadyButton->setIcon(QIcon(":/images/64x64/hdready.png"));
//  hdreadyButton->setFlags(Qt::ItemIsSelectable | Qt::ItemIsEnabled);
...
//    case 0:
//      standardMsg="HDTV 1080";break;

//    case 1:
//      standardMsg="HD Ready";break;
...
{
  //ImageViewer *v = new ImageViewer(audioMenuLineEdit->setXmlFromWidget());
  //v->show();
}
