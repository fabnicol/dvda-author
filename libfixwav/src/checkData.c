...
int pad_end_of_file(WaveData* info, globalData* globals)
{
...
void check_real_size(WaveData *info, WaveHeader *header, globalData* globals)
{
...
int prune(WaveData *info, WaveHeader *header, globalData* globals)
{
