...
void flacWriter::showState(int initcode, const char *msg)
{
    ...
    switch (get_state())
        {
        case FLAC__FILE_ENCODER_OK :
            break;
        case FLAC__FILE_ENCODER_NO_FILENAME :
            LOG("FILE_ENCODER_NO_FILENAME\n");
            break;
        case FLAC__FILE_ENCODER_SEEKABLE_STREAM_ENCODER_ERROR :
            LOG("FILE_ENCODER_SEEKABLE_STREAM_ENCODER_ERROR\n");
            break;
        case FLAC__FILE_ENCODER_FATAL_ERROR_WHILE_WRITING :
            LOG("FILE_ENCODER_FATAL_ERROR_WHILE_WRITING\n");
            break;
        case FLAC__FILE_ENCODER_ERROR_OPENING_FILE :
            LOG("FILE_ENCODER_ERROR_OPENING_FILE\n");
            break;
        case FLAC__FILE_ENCODER_MEMORY_ALLOCATION_ERROR :
            LOG("FILE_ENCODER_MEMORY_ALLOCATION_ERROR\n");
            break;
        case FLAC__FILE_ENCODER_ALREADY_INITIALIZED :
            LOG("FILE_ENCODER_ALREADY_INITIALIZED\n");
            break;
        case FLAC__FILE_ENCODER_UNINITIALIZED :
            LOG("FILE_ENCODER_UNINITIALIZED\n");
            break;
        }

    switch (get_seekable_stream_encoder_state())
        {
        case FLAC__SEEKABLE_STREAM_ENCODER_OK:
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_STREAM_ENCODER_ERROR:
            LOG("SEEKABLE_STREAM_ENCODER_STREAM_ENCODER_ERROR\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_MEMORY_ALLOCATION_ERROR:
            LOG("SEEKABLE_STREAM_ENCODER_MEMORY_ALLOCATION_ERROR\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_WRITE_ERROR:
            LOG("SEEKABLE_STREAM_ENCODER_WRITE_ERROR\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_READ_ERROR:
            LOG("SEEKABLE_STREAM_ENCODER_READ_ERROR\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_SEEK_ERROR:
            LOG("SEEKABLE_STREAM_ENCODER_SEEK_ERROR\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_TELL_ERROR:
            LOG("SEEKABLE_STREAM_ENCODER_TELL_ERROR\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_ALREADY_INITIALIZED:
            LOG("SEEKABLE_STREAM_ENCODER_ALREADY_INITIALIZED\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_INVALID_CALLBACK:
            LOG("SEEKABLE_STREAM_ENCODER_INVALID_CALLBACK\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_INVALID_SEEKTABLE:
            LOG("SEEKABLE_STREAM_ENCODER_INVALID_SEEKTABLE\n");
            break;
        case FLAC__SEEKABLE_STREAM_ENCODER_UNINITIALIZED:
            LOG("SEEKABLE_STREAM_ENCODER_UNINITIALIZED\n");
            break;
        }
    ...
    switch (get_stream_encoder_state())
        ...
        case FLAC__STREAM_ENCODER_VERIFY_DECODER_ERROR :
            LOG("STREAM_ENCODER_VERIFY_DECODER_ERROR\n");
            break;
        case FLAC__STREAM_ENCODER_VERIFY_MISMATCH_IN_AUDIO_DATA :
            LOG("STREAM_ENCODER_VERIFY_MISMATCH_IN_AUDIO_DATA\n");
            break;
        case FLAC__STREAM_ENCODER_INVALID_CALLBACK :
            LOG("STREAM_ENCODER_INVALID_CALLBACK\n");
            break;
        case FLAC__STREAM_ENCODER_INVALID_NUMBER_OF_CHANNELS :
            LOG("STREAM_ENCODER_INVALID_NUMBER_OF_CHANNELS\n");
            break;
        case FLAC__STREAM_ENCODER_INVALID_BITS_PER_SAMPLE :
            LOG("STREAM_ENCODER_INVALID_BITS_PER_SAMPLE\n");
            break;
        case FLAC__STREAM_ENCODER_INVALID_SAMPLE_RATE :
            LOG("STREAM_ENCODER_INVALID_SAMPLE_RATE\n");
            break;
        case FLAC__STREAM_ENCODER_INVALID_BLOCK_SIZE :
            LOG("STREAM_ENCODER_INVALID_BLOCK_SIZE\n");
            break;
        case FLAC__STREAM_ENCODER_INVALID_MAX_LPC_ORDER :
            LOG("STREAM_ENCODER_INVALID_MAX_LPC_ORDER\n");
            break;
        case FLAC__STREAM_ENCODER_INVALID_QLP_COEFF_PRECISION :
            LOG("STREAM_ENCODER_INVALID_QLP_COEFF_PRECISION\n");
            break;
        case FLAC__STREAM_ENCODER_MID_SIDE_CHANNELS_MISMATCH :
            LOG("STREAM_ENCODER_MID_SIDE_CHANNELS_MISMATCH\n");
            break;
        case FLAC__STREAM_ENCODER_MID_SIDE_SAMPLE_SIZE_MISMATCH :
            LOG("STREAM_ENCODER_MID_SIDE_SAMPLE_SIZE_MISMATCH\n");
            break;
        case FLAC__STREAM_ENCODER_ILLEGAL_MID_SIDE_FORCE :
            LOG("STREAM_ENCODER_ILLEGAL_MID_SIDE_FORCE\n");
            break;
        case FLAC__STREAM_ENCODER_BLOCK_SIZE_TOO_SMALL_FOR_LPC_ORDER :
            LOG("STREAM_ENCODER_BLOCK_SIZE_TOO_SMALL_FOR_LPC_ORDER\n");
            break;
        case FLAC__STREAM_ENCODER_NOT_STREAMABLE :
            LOG("STREAM_ENCODER_NOT_STREAMABLE\n");
            break;
        case FLAC__STREAM_ENCODER_FRAMING_ERROR :
            LOG("STREAM_ENCODER_FRAMING_ERROR\n");
            break;
        case FLAC__STREAM_ENCODER_INVALID_METADATA :
            LOG("STREAM_ENCODER_INVALID_METADATA\n");
            break;
        case FLAC__STREAM_ENCODER_FATAL_ERROR_WHILE_ENCODING :
            LOG("STREAM_ENCODER_FATAL_ERROR_WHILE_ENCODING\n");
            break;
        case FLAC__STREAM_ENCODER_FATAL_ERROR_WHILE_WRITING :
            LOG("STREAM_ENCODER_FATAL_ERROR_WHILE_WRITING\n");
            break;
        case FLAC__STREAM_ENCODER_MEMORY_ALLOCATION_ERROR :
            LOG("STREAM_ENCODER_MEMORY_ALLOCATION_ERROR\n");
            break;
        case FLAC__STREAM_ENCODER_ALREADY_INITIALIZED :
            LOG("STREAM_ENCODER_ALREADY_INITIALIZED\n");
            break;
        }
    /*
