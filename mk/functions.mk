...
define docfollow
	@findstring=$$(find /home/fab/Dev/dvda-author-dev/BUILD -maxdepth 1 -name $(strip $1) -print0)
	echo "[doc]" >> /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE
	echo "    $1 $$findstring" >> /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE 
endef

define index
	@echo [$1] >> /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE
	directory=$(MAYBE_$1)
	if test "$3" = "library" ; then
	   testvar=$$(find /home/fab/Dev/dvda-author-dev/BUILD/$$directory -maxdepth 4 -type f -wholename "*$1$2" -print0)
	else
	   testvar=$$(find /home/fab/Dev/dvda-author-dev/BUILD/$$directory -maxdepth 4 -type f -wholename "*$($1_TESTBINARY)$2" -print0)
	fi
	if test "$$testvar" != ""; then
		echo "     built $3: $$testvar for $1" >> /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE
		if test "$3" = "library" ; then
		  testvar2=$$(find /home/fab/Dev/dvda-author-dev/BUILD/local/lib -wholename $($1_LIB) -print0)
		else
		  testvar2=$$(find /home/fab/Dev/dvda-author-dev/BUILD/local/bin -name "$($1_TESTBINARY)$(EXEEXT)" -print0)
		fi
		if test "$$testvar2" != ""; then
			echo "     local $3: $$testvar2 from $(MAYBE_$1)" >> /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE
		else
			echo "     did not install $3 $1" >> /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE
		fi
	else
	        echo "     no $3 $1" >> /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE
	fi
endef
...
define configure_sub_package
	...
	if test "$$target_subdir" != ""; then
	   if test -d  "/home/fab/Dev/dvda-author-dev/$$target_subdir"; then
	      mkdir -p "/home/fab/Dev/dvda-author-dev/BUILD/$$target_subdir/"
	      cd "/home/fab/Dev/dvda-author-dev/BUILD/$$target_subdir/"
	      if test "$(findstring noconfigure,$5)" = "" ; then 
	       ...
	       $(SHELL) "/home/fab/Dev/dvda-author-dev/$$target_subdir/configure" $$configure_flags --prefix="/home/fab/Dev/dvda-author-dev/BUILD/local" CPPFLAGS="-I/home/fab/Dev/dvda-author-dev/BUILD/local/include"  $6
	      else
	       if test "/home/fab/Dev/dvda-author-dev" != "/home/fab/Dev/dvda-author-dev/BUILD"; then cp -rf "/home/fab/Dev/dvda-author-dev/$$target_subdir" /home/fab/Dev/dvda-author-dev/BUILD; fi
	      fi
	      if test "$$?" = "0"; then  
	      echo -- *****
	      echo -- * Now building $1
	      echo -- * See file /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE --
	      echo -- *****
		  echo Now building $1 with command line $(MAKE) $(PARALLEL) MKDIR_P="\"$(MKDIR_P)\""  $(if $6,$6)...  >> /home/fab/Dev/dvda-author-dev/BUILD/depconf/BUILD.TRACE
	      ...
	      cd /home/fab/Dev/dvda-author-dev/BUILD
	   fi
	fi
endef
...
define configure_lib_package
	...
	if test "$$?" = "0"; then
	  touch /home/fab/Dev/dvda-author-dev/BUILD/depconf/$1.depconf
	fi
...
define clean_directory
	for dir in $1; do
	   if test -d "$$dir" ; then
	     cd "$$dir"; $(RM) *.a *.po *.o *.1 *.html; cd /home/fab/Dev/dvda-author-dev/BUILD
	   fi
	done
endef
