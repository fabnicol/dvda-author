...
printf("%s","    --aob-extract AOB    Direct AOB file audio content extraction. " J "Unlike -x, this option does not use .IFO files. Use this option in combination with -o. No wav header is generated.\n\n");
printf("%s","    --aob2wav AOB        Like --aob-extract but a wav header is prepended to audio content.\n\n");
