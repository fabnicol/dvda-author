...
printf("%s","    --forensic           Use this mode with --aob-extract or --aob2wav if IFO files are missing or mangled, or AOB files" J "have been partially restored using recovery tools.\n\n");
printf("%s","    --log-decode [AOB]   Decode AOB file and log MPEG specifics. Should be used only in conjunction with --outfile\n\n");
printf("%s","    --scan-info [IFO]    Scanning information given by IFO file\n\n");
