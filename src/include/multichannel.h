...
ALWAYS_INLINE_GCC static inline void permutation(uint8_t *buf, uint8_t *_buf, int bits_per_second_flag, uint8_t channels, short int reference_table[][6][36], int size)
{
    int j;
